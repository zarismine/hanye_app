...
type GetDishesByCategoryIdQueryLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewGetDishesByCategoryIdQueryLogic(ctx context.Context, svcCtx *svc.ServiceContext) *GetDishesByCategoryIdQueryLogic {
	return &GetDishesByCategoryIdQueryLogic{
...
func (l *GetDishesByCategoryIdQueryLogic) GetDishesByCategoryIdQuery(req *types.GetDishesByCategoryIdQueryReq) (resp *types.GetDishesByCategoryIdResp, err error) {
