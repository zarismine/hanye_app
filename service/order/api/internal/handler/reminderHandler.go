...
func reminderHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ReminderReq
		...
		req.UserId = token.Id
		l := logic.NewReminderLogic(r.Context(), svcCtx)
		resp, err := l.Reminder(&req)
		if err != nil {
			httpx.ErrorCtx(r.Context(), w, err)
		} else {
