...
type SubCartLogic struct {
	logx.Logger
	ctx    context.Context
	svcCtx *svc.ServiceContext
}

func NewSubCartLogic(ctx context.Context, svcCtx *svc.ServiceContext) *SubCartLogic {
	return &SubCartLogic{
...
func (l *SubCartLogic) SubCart(req *types.AddSubCartReq) (resp *types.AddSubCartResp, err error) {
